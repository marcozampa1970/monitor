...
public class Swagger2Config {
    ...
    @Bean
    public Docket api() {
	return new Docket(DocumentationType.SWAGGER_2).select().apis(RequestHandlerSelectors.basePackage("com.zetaemmesoft.auth.controller"))
	...
	return new ApiInfoBuilder().title("Zetaemmesoft Auth REST API").build();
    }
