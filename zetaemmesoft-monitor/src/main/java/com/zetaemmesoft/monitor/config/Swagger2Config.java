...
public class Swagger2Config {
    ...
    @Bean
    public Docket api() {
	return new Docket(DocumentationType.SWAGGER_2).select().apis(RequestHandlerSelectors.basePackage("com.zetaemmesoft.monitor.controller"))
	...
	return new ApiInfoBuilder().title("Zetaemmesoft Monitor REST API").build();
    }
