package com.zetaemmesoft.monitor.integration.repository;
...
import com.zetaemmesoft.monitor.integration.mapper.SensorRowMapper;
...
public class SensorRepository {
	...
	logger.info("Status " + status + " for id: " + dto.getId());
    }
